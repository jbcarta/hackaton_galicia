...
//             dom: 'Bfrtip',
        ...
        $('#tcecos tbody').on( 'click', 'tr', function () 
        {
            ...
            {
               var tval =   '<a href="#" data-toggle="modal" data-target=".modal-cecos">'+data["ceco"]+':'+data["description"]+ 
                            '<input type="text" name="costcenter" id="costcenter" '+
                            ' value='+data["ceco"]+':'+data["description"]+' hidden="true"></a>';
            ...
            // called from:
            //      suppliers_edit.hbs
            var table = $('#tceco').DataTable();
            if (table.cell( $("#currentRow").val(), 1).data())
            {
               var tval =   '<a href="#" data-toggle="modal" data-target=".modal-cecos">'+data["ceco"]+':'+data["description"]+ 
                            '<input type="text" name="ceco" id="ceco" '+
                            ' value='+data["ceco"]+':'+data["description"]+' hidden="true"></a>';
