...
//             dom: 'Bfrtip',
            ...
            "columns": 
                [
//                    { "title":"ID","data": "_id"},
                    { "title":"Area Aprobadora","data": "approvalarea", "defaultValue": null },
...
//            alert("data : "+data["supplier"]);
            ...
            document.body.innerHTML += '<form id="dynForm" action="/approvalscheme_by_approvalarea_detail" method="post"><input type="hidden" name="post_id" value="'+xid+'"></form>';
