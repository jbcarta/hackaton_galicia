...
//            $("#account").val(data["account"]+":"+data["description"]);
            ...
            {
               var tval =   '<a href="#" data-toggle="modal" data-target=".modal-fiorders">'+data["order"]+':'+data["description"]+ 
                            '<input type="text" name="fiorder" id="fiorder" '+
                            ' value='+data["order"]+':'+data["description"]+' hidden="true"></a>';
