    ...
    {   
        ...
        // -----------------------------------
        var oTable =  $('#tsupplierinvoice_sap').DataTable(
        {
            //"pagingType": "full",
            "bPaginate": false,
            "pageLength": 200,            
...
//             dom: 'Bfrtip',
        ...
        //         #ts tbody CLICK
        // -----------------------------------
        $('#tsupplierinvoice_sap tbody').on( 'click', 'tr', function () 
        {
...
//            alert("data : "+data["supplier"]);
            ...
            document.body.innerHTML += '<form id="dynForm" action="/supplierinvoice_viewsap" method="post"><input type="hidden" name="post_id" value="'+xid+'"></form>';
